...
if __name__ == '__main__':
    APP_ID = "5e50cfbe"
    SECRET_KEY = "9a61ab9388f85b9415330cd95b89a57e"
    file_path = r"D:\\下载\\test2.mp3"
    api = RequestApi(appid=APP_ID, secret_key=SECRET_KEY,
                     upload_file_path=file_path)
    # api.all_api_request()

    api.get_result_request("e29925f424714967937f31dbcdd04332")
    # res = api.get_result_request("fdb7bbc6619e49efa2c115176e8fd6e6")
